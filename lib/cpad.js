    ...
    return getPlace(data.query.near, function(err, place) {
      ...
      fullQuery = {
        text: [
          ...
          "ORDER BY NOT ARRAY['kiteboardingwindsurfing','climbing','horsebackriding','rusticcabins','caving','whitewaterraftingkayaking','boating','backpacking','historicalsite','fishing','biking','hiking','swimming','ohv','kayakingcanoeing','snowsports','wildlifewatching','surfing','camping'] @> activities.activities,",
          "  distance ASC",
          "OFFSET $3",
          "LIMIT $4"
        ].join('\n'),
