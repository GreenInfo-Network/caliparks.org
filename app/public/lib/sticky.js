/**
 *
 * Minimally modified version of "react-sticky"
 * @URL: https://github.com/captivationsoftware/react-sticky
 *
 * @CHANGES
 * - Added a 'getBodyHeight' method
 * - Added a 'bodyHeight' variable to keep track if overall
 *   height of the page changes, if so, re-calculate 'origin'
 *
 */
...
var Sticky = React.createClass({
  ...
  shouldBeSticky: function() {
    const bh = this.getBodyHeight();
    if (bh !== this.bodyHeight) {
      this.bodyHeight = bh;
